...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Fui criada!", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        super.onStart();
        Toast.makeText(this, "Iniciei!", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onPause() {
        super.onPause();
        Toast.makeText(this, "Pausei...", Toast.LENGTH_SHORT).show();
    }

    @Override
    protected void onStop() {
        super.onStop();
        Toast.makeText(this, "Parei!", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        Toast.makeText(this, "Fui destruída...", Toast.LENGTH_SHORT).show();
    }
}